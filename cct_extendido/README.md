...
| Bloque                         | Variable en tu código                                           | ¿Real, estimado o simulado?                  | De dónde sacarlo / cómo (según paper)                                                                                                                                                                                                                         |
| ------------------------------ | --------------------------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Población**                  | `N`                                                             | Simular (tamaño de muestra)                  | El paper usa encuestas reales para **calibrar** y luego simula; puedes elegir N para tu experimento.                                                                                                                                                          |
| **Horizonte**                  | `Tmax`                                                          | Simular                                      | Decisión de diseño (meses).                                                                                                                                                                                                                                   |
| **Reglas CCT**                 | `base_transfer_per_child`, `max_children_paid`, `poverty_line`  | **Real (política)**                          | **Reglas oficiales del programa** (p.ej. Bolsa Família/Prospera: monto por niño, tope de hijos, línea de pobreza). El paper toma reglas reales del BFP (R$35–R$105, elegibilidad hasta R$137/mes al momento del estudio).                                     |
